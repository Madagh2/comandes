 ...
 */
define("DB_USER", 'cifpemba_comandes');
define("DB_PASSWORD", 'C0m4nd3s!');
define("DB_NAME", 'cifpemba_comandes');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'backup'); // Comment this line to use same script's directory ('.')
//define("TABLES", '*'); // Full backup
define("TABLES", $tablas); // Partial backup
...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile              = date("Y-m-d_His", time()).'.sql';
